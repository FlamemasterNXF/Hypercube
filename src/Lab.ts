...
export const initializeTechs = () => {
    ...
    temp.techs[4] = new Tech('Self-Replicating Technology', 'Miners no longer require Cubes and automatically build Miners', D(1e10), true,"100 Meteorite Shards required!")
    ...
    temp.techs[9] = new Tech('High Dimension Stability', 'Divide the cost of all Cube Types above Cube by 1.1', D(1e7), true,"1 Penteract Required!")
