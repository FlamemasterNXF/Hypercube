...
export const initializeTechs = () => {
    ...
    temp.techs[8] = new Tech('Retroactive Optimization', 'All Cube Types produce more Energy for each Cube Type you have at least 1 of', D(3e5), true,"Nothing Special Required")
