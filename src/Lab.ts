...
export const initializeTechs = () => {
    ...
    temp.techs[3] = new Tech('Advanced Circuits', 'Miners require -30J each', D(1e6), true,"1 Penteract Required!")
    temp.techs[4] = new Tech('Self-Replicating Technology', 'Miners no longer require Cubes', D(1e10), true,"100 Meteorite Shards required!")
    ...
    temp.techs[8] = new Tech('Retroactive Optimization', 'All Cube Types produce more Energy based on how many Miners you have', D(3e5), true,"Nothing Special Required")
    temp.techs[9] = new Tech('High Dimension Stability', 'Divide the cost of all Cube Types above Cube by 1.1', D(1e7), true,"Nothing Special Required")
    temp.techs[10] = new Tech('Energetic Cores', 'All Cube Types have +1 effective dimensions for energy production purposes (Cubes produce 200 Joules, Tesseracts produce 3000 Joules, etc)', D(1e10), true,"100 Meteorite Shards are required!")
